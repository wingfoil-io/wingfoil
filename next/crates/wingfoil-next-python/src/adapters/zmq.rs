//! Python bindings for the wingfoil-next **ZeroMQ** adapter
//! ([`wingfoil_next::adapters::zmq`]).
//!
...
//!
//! ```python
//! data, status = wingfoil_next.zmq_sub(g, "tcp://localhost:5556")
//! ```
//!
...
use anyhow::Result;
use wingfoil_next::adapters::zmq::{ZeroMqPub, ZmqStatus, zmq_sub as zmq_subscribe};
