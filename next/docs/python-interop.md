...
mechanism: the per-adapter bindings (postgres, kafka, redis, etcd, fluvio and
csv done, nine to go) and the Phase 4.5 mutable frontier for extending a *running*
graph.
