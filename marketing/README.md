...
| # | Topic | Status | File | Angle |
|---|-------|--------|------|-------|
| 1 | Bun rewrite / agentic coding | ✅ Posted | [`linkedin/rust-agentic-coding.md`](linkedin/rust-agentic-coding.md) | Topical opener — leads with the Bun-to-Rust merge, makes the case for Rust as an agent-friendly language. |
| 2 | Iceoryx2 adapter | ✅ Posted | [`linkedin/iceoryx2.md`](linkedin/iceoryx2.md) | Zero-copy shared-memory IPC for splitting a graph across processes on one box. |
...
| 5 | Kafka adapter | ✅ Posted | [`linkedin/kafka.md`](linkedin/kafka.md) | Two nodes, multi-topic publish, per-burst delivery via `FuturesUnordered`. |
