...
`#[must_use]` on the returned stream, and — if `Signal` has or should have the
twin — a delegation rather than a second copy of the body. Steps 4b, 6 and 9
below apply unchanged; steps 2, 3 and 5 do not.
