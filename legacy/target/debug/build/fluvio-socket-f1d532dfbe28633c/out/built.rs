...
#[allow(dead_code)]
pub static PKG_AUTHORS: &str = "Fluvio Contributors <team@fluvio.io>";
#[doc=r#"The name of the package."#]
#[allow(dead_code)]
pub static PKG_NAME: &str = "fluvio-socket";
#[doc=r#"The description."#]
#[allow(dead_code)]
pub static PKG_DESCRIPTION: &str = "Provide TCP socket wrapper for fluvio protocol";
#[doc=r#"The homepage."#]
#[allow(dead_code)]
...
#[allow(dead_code)]
pub static PKG_REPOSITORY: &str = "https://github.com/infinyon/fluvio";
