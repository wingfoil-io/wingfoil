...
The proc macros behind [`wingfoil-next`](../wingfoil-next/): **`nitro!`** and
**`#[op]`**.
...
[`examples/core/dual_mode/`](../wingfoil-next/examples/core/dual_mode/) is the
...
separate crate rather than a module of `wingfoil-next`.
...
- [`../wingfoil-next/`](../wingfoil-next/) — the engine these macros serve
- [`../wingfoil-next-python-macros/`](../wingfoil-next-python-macros/) — the same idea for the Python bindings
