...
This is the Python-side counterpart to [`#[op]`](../wingfoil-next-macros/): where
...
- [`../wingfoil-next-python/`](../wingfoil-next-python/) — the extension module this feeds
- [`../wingfoil-next-macros/`](../wingfoil-next-macros/) — `nitro!` and `#[op]`
