"""wingfoil-next — Python bindings.

`wingfoil_next` is a thin Python package over the compiled extension
(`wingfoil_next._wingfoil`): everything the extension exports is re-exported
