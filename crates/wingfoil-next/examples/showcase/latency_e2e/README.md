...
```bash
bash crates/wingfoil-next/examples/showcase/latency_e2e/cleanup_stale_shm.sh
```
...
docker compose -f crates/wingfoil-next/examples/showcase/latency_e2e/docker-compose.yml up -d
```
