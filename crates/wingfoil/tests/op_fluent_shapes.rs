...
//!
//! `crates/wingfoil/src/{fluent,stats}.rs` already invoke all three, and
...
impl MyStatOps for Stream<f64> {
    wingfoil::__wf_fluent_rolling_mean!();
    wingfoil::__wf_fluent_cumulative_sum!();
}
...
impl MySourceOps for GraphBuilder {
    wingfoil::__wf_fluent_ticker!();
    wingfoil::__wf_fluent_constant!();
}
