...
3. **Five service images** in ECR (or Docker Hub) — see
   `crates/wingfoil/examples/showcase/latency_e2e/Dockerfile.*` and
...
```bash
cd crates/wingfoil/examples/showcase/latency_e2e/pulumi/ec2-spot/packer
...
```bash
cd crates/wingfoil/examples/showcase/latency_e2e/pulumi/ec2-spot
...
rsync -av --delete \
  crates/wingfoil/examples/showcase/latency_e2e/static/ \
