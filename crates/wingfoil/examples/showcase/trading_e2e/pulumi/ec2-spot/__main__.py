"""
Always-on EC2 Spot deployment of the wingfoil trading_e2e demo.
...
Prerequisites:
  ...
  - The five trading_e2e Docker images pushed to a registry (ECR or Hub)
  - A Packer-built AMI ID; build it locally or via the GitHub Action at
    `.github/workflows/build-trading-e2e-ami.yml`
