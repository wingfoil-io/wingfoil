...
Deploy the complete trading_e2e demo (5 containers: fix_gw, ws_server, prometheus, tempo, grafana) to AWS ECS Fargate using Pulumi.
...
```bash
cd crates/wingfoil/examples/showcase/trading_e2e/pulumi
python3 -m venv venv
