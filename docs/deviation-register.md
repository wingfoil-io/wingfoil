...
| D5 | **otlp pins opentelemetry 0.32; legacy still on 0.28.** | 🟢 | **Won't-fix — moot at cutover.** Deliberate divergence for security (GHSA-w9wp-h8wv-79jx, #543). Legacy is retired wholesale at cutover, so next's 0.32 is the surviving version and the legacy-side advisory disappears with the legacy tree; bumping legacy to restore lockstep is not worth the churn. |
